...
export default class Entity {
    ...
    getTranslatedBounds (x = this.x, y = this.y) {
        if (this.bounds) {
            ...
            return new Box(new Vector(pos.x + x, pos.y + y), w, h).toPolygon()
        }         
    ...
    move () {
        ...
        const PX = Math.floor(this.expectedX  / world.spriteSize)
        const PY = Math.floor(this.expectedY / world.spriteSize)
