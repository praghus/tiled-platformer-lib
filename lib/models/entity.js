...
export default class Entity {
    ...
    move () {
        ...
        this.expectedX = Math.round(this.x + this.force.x)
        this.expectedY =  Math.round(this.y + this.force.y)
                            ...
                            if (tile && tile.isSolid()) {
                                ...
                                const overlap = tile.overlapTest(
                                    this.getTranslatedBounds(
                                        Math.round(this.x + this.force.x), 
                                        Math.round(this.y + this.force.y)
                                    )
                                )
                                // @fixme
